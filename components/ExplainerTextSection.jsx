		...
		[
			{
				...
				content: (
					<Typography variant="h1" color="primary">
						<span style={{ color: '#FFD500' }}>{translated.Battle}</span>
						<br />
						{translated.Sound}
					</Typography>
				)
			},
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.SplashPage}</Typography>
				)
			}
		],
		[
			{
				...
				padding:0,
				content: (
					<Image src={'/img/AP22072771666802.jpeg'} layout="fill" alt="Alt text here"/>
				)
			},
			{
				position: {
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Motivation1}</Typography>
				)
			}
		],
		[
			{
				...
				padding:0,
				content: (
					<Image src={'/img/AP22060795547794.jpeg'} layout="fill" alt="Alt text here"/>
				)
			},
			{
				position: {
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Motivation2}</Typography>
				)
			}
		],
		[
			
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Method1}</Typography>
				)
			}
		],
		[
			
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Method2}</Typography>
				)
			}
		],
		[
			
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Method3}</Typography>
				)
			}
		],
		[
			
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Method4}</Typography>
				)
			}
		],
		[
			
			{
				...
				border: true,
				content: (
					<Typography variant="h2" color="primary">{translated.Onboarding}</Typography>
				)
			}
		],
	]
